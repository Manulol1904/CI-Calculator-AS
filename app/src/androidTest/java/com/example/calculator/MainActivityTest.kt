...
class MainActivityTest {
    ...
    fun mainActivityTest() {
        ...
        appCompatEditText.perform(ViewActions.replaceText("12"), ViewActions.closeSoftKeyboard())
        ...
        appCompatEditText2.perform(ViewActions.replaceText("2"), ViewActions.closeSoftKeyboard())
        ...
        appCompatEditText3.perform(ViewActions.replaceText("2"), ViewActions.closeSoftKeyboard())
        ...
        val materialButton9 = Espresso.onView(
            Matchers.allOf(
                ViewMatchers.withId(R.id.MOP2), ViewMatchers.withText("Ir a Fibonacci"),
                childAtPosition(
                    childAtPosition(
                        ViewMatchers.withId(android.R.id.content),
                        0
        ...
        appCompatEditText4.perform(ViewActions.replaceText("2"), ViewActions.closeSoftKeyboard())
        val materialButton10 = Espresso.onView(
            Matchers.allOf(
                ViewMatchers.withId(R.id.Fib), ViewMatchers.withText("Fibonacci"),
                childAtPosition(
                    childAtPosition(
                        ViewMatchers.withId(android.R.id.content),
                        0
        ...
        val materialButton11 = Espresso.onView(
            Matchers.allOf(
                ViewMatchers.withId(R.id.back2), ViewMatchers.withText("Volver"),
                childAtPosition(
                    childAtPosition(
                        ViewMatchers.withId(android.R.id.content),
                        0
